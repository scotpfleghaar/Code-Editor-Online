$(document).ready(function () {
    ...
    $('.qbank').append(`<div class="col-sm-10 col-sm-offset-1 add-button total-details">
        <div style="text-align: center;">
            <button class='btn btn-lg add-question-edit'>Add Question</button>
        </div>
    </div>`);

    $('.add-question-edit').off('click').on('click', function () {
        var j = (($('.editor').length / 2) + 1);
        $('.add-button').before(`
        <div class="container total-details">
        <div class="row">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <hr>
                    <h1 style="text-align: center;">Question ${(j)}</h1>
                </div>
                ...
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <h2>Indstructions:</h2>
                        <div>
                            <pre contenteditable="true" class="instructions"><xmp></xmp></pre>
                        </div>
                        <div class="row">
                            <div class="col-sm-12 editor-display">
                            <h2>Starter Code:</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-md-offset-1">
                <h2>Explination:</h2>
                    <div  class="alert alert-info explination"><pre contenteditable="true"><xmp></xmp></pre></div>
                </div>
                <div class="col-md-10 col-md-offset-1">
                <h2>Multiple Choice Section:</h2>
                    <ul class="choices list-group">
                        <li class="choice list-group-item"><small>Answer 1: </small><pre contenteditable="true"><xmp></xmp></pre></li>
                        <li class="choice list-group-item"><small>Answer 2: </small><pre contenteditable="true"><xmp></xmp></pre></li>
                        <li class="choice list-group-item"><small>Choice 1: </small><pre contenteditable="true"><xmp></xmp></pre></li>
                        <li class="choice list-group-item"><small>Choice 2: </small><pre contenteditable="true"><xmp></xmp></pre></li>
                        <li class="choice list-group-item"><small>Choice 3: </small><pre contenteditable="true"><xmp></xmp></pre></li>
                        <li class="choice list-group-item"><small>Choice 4: </small><pre contenteditable="true"><xmp></xmp></pre></li>
                        <li class="choice list-group-item"><small>Choice 5: </small><pre contenteditable="true"><xmp></xmp></pre></li>
                    </ul>
                    <hr>
                </div>
            </div>
